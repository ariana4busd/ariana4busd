    ...
    <>
      ...
      <section className={css.section}>
        ...
        <p>
          ...
          school districts. She applied evidenced based, person-in-environment,
          and problem solving approaches to program evaluation, crisis response,
          and providing mental health services to students. During her time
          working at OCDE - Safe Schools & Support Services, she gained
          experience working with students, parents, teachers, and school
          administrators to support Alcohol, Tobacco, and Other Drug prevention,
          Anti-Bullying, Individual and Group Crisis Response, and Gang
